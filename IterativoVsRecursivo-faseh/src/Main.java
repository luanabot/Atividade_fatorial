...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7: \t Fatorial iterativo");
            System.out.println("8: \t Fatorial recursivo");
            ...
            try {
                ...
                switch (opt) {
                    ...
                    case 7 -> {
                        ...
                        System.out.println("Resultado (iterativo): " + fatorial.fatorialIterativo(numero));
                    }
                    ...
                    case 8 -> {
                        ...
                        System.out.println("Resultado (recursivo): " + fatorial.fatorialRecursivo(numero));
                    }
                    default -> {
                        if(opt != 0){
